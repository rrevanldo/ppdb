...
<br>
    ...
    <div class="px-0 py-5" style="background: #02225B" id="hubungikami">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="center-heading">
                        <h2 class="section-title font-weight-bold text-white" align="center">Hubungi Kami</h2>
                    </div>
                    <h5 class="text-white font-weight-bold">Kontak Pendaftaran</h5>
                    <div class="contact-text">
                        <p class="text-white">Jl. Raya Wangun No.21, RT.01/RW.06, Sindangsari, Kec. Bogor Tim., Kota Bogor, Jawa Barat 16146 prohumasi@smkwikrama.net</p>
                        <p align="center" class="text-white">CS 1 : <a style="text-decoration: underline !important; font-weight: bold !important" href="https://wa.me/6281909242411">hubungi kami (klik disini)</a>
                        ...
                        <div class="daftar ml-5"><a href="/register" class="btn btn-warning text-black btn-lg ml-5">Daftar Sekarang</a></div>
                    </div>
                    <div class="wrapper mt-5">
                        <div class="col">
                            <div class="form-group">
                                <input id="form_name" type="text" name="nama" class="form-control"
                                    required="required" data-error="Firstname is required." placeholder="Nama Lengkap">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <input id="form_name" type="number" name="nohp" class="form-control"
                                    required="required" data-error="Firstname is required." placeholder="+62">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <input id="form_name" type="text" name="email" class="form-control"
                                    required="required" data-error="Firstname is required." placeholder="Alamat Email">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <textarea id="form_message" name="pesan" class="form-control" rows="4" required="required"
                                    data-error="Please, leave us a message." placeholder="Pesan"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="pesan">
                                <button type="submit" id="contactus-submit" class="btn btn-warning text-black btn-lg"
                                    action="">Kirim Pesan</button>
                                </div>
                            </div>
                        </div>
                    </div>
